// Allow overriding API base at build time; default to backend port 5001.
const API = import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5002/api' : '/api');
